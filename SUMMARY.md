...
- [file/文件夹与文件](linux_cmd/file.md)
- [locate/文件搜索](linux_cmd/file_search.md)
- [find命令](linux_cmd/find.md)
- [firewall-cmd/防火墙](linux_cmd/firewall.md)
- [mount/文件系统](linux_cmd/fs.md)
- [关闭和重启](linux_cmd/machine.md)
- [网络](linux_cmd/network.md)
- [rpm/包管理](linux_cmd/package.md)
- [ps/进程命令](linux_cmd/ps.md)
...
- [VirtualBox实践](DevOps/VirtualBox/README.md)
