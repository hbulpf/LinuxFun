...
- [下载](linux_cmd/download.md)
- [文件夹与文件](linux_cmd/file.md)
- [文件搜索](linux_cmd/file_search.md)
- [find命令](linux_cmd/find.md)
- [防火墙](linux_cmd/firewall.md)
- [文件系统](linux_cmd/fs.md)
- [关闭和重启](linux_cmd/machine.md)
- [网络](linux_cmd/network.md)
- [其他常见知识](linux_cmd/others.md)
- [包管理](linux_cmd/package.md)
- [进程命令](linux_cmd/ps.md)
- [输入输出重定向](linux_cmd/redirect.md)
- [英文简写](linux_cmd/remember.md)
- [软件下载使用](linux_cmd/software.md)
- [内核命令](linux_cmd/system.md)
- [打包和压缩文件](linux_cmd/tar.md)
